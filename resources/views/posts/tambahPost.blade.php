         ...
         <div class="row justify-content-between">
           ...
           <div class="col-md-8">
             <br>
               <div class="form-group">
                 ...
                 @endif
                 <input required type="text" name="judul" class="form-control" id="judul" placeholder="Masukkan judul post ..." value="{{old('judul')}}">
               </div>
               <div class="form-group">
                 ...
                 @endif
                 <textarea class="form-control" name="isi_post" id="my-editor" rows="28">{{old('isi_post')}}</textarea>
               </div>
           </div>
           {{-- end kolom post --}}
           ...
           <div class="col-md-4">
             ...
             <div class="form-group">
               ...
               @endif
              <input required autocomplete="off" required type="text" class="form-control datepicker" name="tanggal" placeholder=" Hari Bulan Tahun" value="{{old('tanggal')}}">
             </div>
             <div class="form-group">
               ...
               <div class="input-group mb-3">
                 <select id="tags" class="form-control" name="kategori[]">
                   <option value="99">Pilih Kategori</option>
                   @foreach ($tags as $tag)
                     <option id="op{{$tag->nama_tag}}" value="{{$tag->id}}">{{$tag->nama_tag}}</option>
                   @endforeach
                 </select>
             ...
             <div class="post_img_holder">
               <img alt="{{old('judul')}}" src="{{old('gambar')}}" id="holder">
             </div>
             <br>
