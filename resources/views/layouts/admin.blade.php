...
<body>
    <div id="app">
      <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="/dashboard">PSE1</a>
        ...
        <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
          ...
          <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
              <a class="dropdown-item" href="/profil-user"><strong>{{ucwords(Auth::user()->name)}}</strong></a>
              ...
              @if (Auth::user()->isAdmin())
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="pagesDropdown1">
                    <a class="dropdown-item" href="/banner-kosong">Banner Kosong</a>
                    <a class="dropdown-item" href="/daftar-banner">Daftar Banner</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="pagesDropdown2">
                    <a class="dropdown-item" href="/web-profil">Profil Puskesmas</a>
                    <a class="dropdown-item" href="/edit-visi-misi-motto">Visi,Misi dan Motto</a>
                    <a class="dropdown-item" href="/waktu">Waktu Pelayanan</a>
            ...
            <footer class="sticky-footer">
              <div class="container my-auto">
                <div class="copyright text-center my-auto">
                  <span>Copyright © Youra 2018</span>
                </div>
              </div>
            </footer>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Klik tombol logout jika anda ingin mengakhiri session ini.</div>
    ...
    <script src="{{asset('js/datatables/jquery.dataTables.js')}}" defer></script>
    <script src="{{asset('js/datatables/dataTables.bootstrap4.js')}}" defer></script>

    <!-- Custom scripts for all pages-->
    <script src="{{asset('js/admin.js')}}" defer></script>
    <script src="{{asset('js/all.min.js')}}" defer></script>
    <script src="{{asset('vendor/laravel-filemanager/js/lfm.js')}}" defer></script>
    <script src="{{asset('js/sweetalert.min.js')}}" defer></script>
    <script src="{{asset('js/pro.js')}}" defer></script>
