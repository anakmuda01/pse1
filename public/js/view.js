  ...
  function BrowserBanner($) {
    ...
    function maybeShowBanner() {
      if (!isSupportedBrowser()) {
        ...
        $browserBanner.html('U gebruikt een verouderde browser, het kan daarom zijn dat onderdelen van de site niet werken. <br> Upgrade <a href="http://browsehappy.com/?locale=nl" target="_blank">uw browser</a> voor een betere, <b>veiligere</b> web ervaring.');
